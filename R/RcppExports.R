...
E_2pl <- function(theta, aA, b, items, ncat) {
    .Call(`_dexterMML_E_2pl`, theta, aA, b, items, ncat)
}

Ew_2pl <- function(theta, aA, b, items, ncat) {
    .Call(`_dexterMML_Ew_2pl`, theta, aA, b, items, ncat)
}

theta_2pl <- function(a, A, b, ncat, pni, pcni, pi, px, WLE = FALSE) {
